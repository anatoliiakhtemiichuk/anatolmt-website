...
export const DEFAULT_SITE_SETTINGS: SiteSettings = {
  ...
  texts: {
    heroTitle: 'M&T ANATOL - Profesjonalny Masaż Terapeutyczny',
    heroSubtitle: 'Doświadczony masażysta, wsparcie w dolegliwościach bólowych kręgosłupa, napięciach mięśniowych oraz powrocie do sprawności po urazach.',
    aboutTitle: 'O nas',
    aboutText: 'Profesjonalny masaż terapeutyczny i praca z ciałem. Indywidualne podejście do każdego klienta.',
